            ...
            <div className="col-12 contenedor-loginRegistro animate__animated animate__flipInX ">
                <div className="col-md-4 col-sm-6 col-12 m-5">
                    <form className='bg-dark formularioLoginRegister ' onSubmit={onLogin}>
                        ...
                        <input onChange={onInputChange()} type="text" placeholder="Email" className='inputLoginRegister' id="username" value={Email} name='Email'></input>

                        <label htmlFor="password">Password</label>
                        <input onChange={onInputChange()} type="password" placeholder="Password" className='inputLoginRegister' id="password" value={password} name='password'></input>

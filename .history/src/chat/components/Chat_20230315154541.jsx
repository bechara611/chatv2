...
export const Chat = () => {
    ...
    }, [mensajesEstado.mensajes])

    return (
        <>
            <div className="col-12 chat2 " ref={referenciaDiv}>
                <div className="col-10 hijoChat"  ref={referenciaDiv}>
                    <div className="col-12 parteMensajes" ref={referenciaDiv}>
                    {
                        mensajesEstado.mensajes.map((mensaje, index) => {
                            return <h1 key={index}>{mensaje.name}</h1>
                        })
                    }
                    </div>

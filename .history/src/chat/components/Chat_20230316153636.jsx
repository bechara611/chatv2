                ...
                <div className="col-10 hijoChat">
                    ...
                    <div className="col-12 parteInputs">
                        <div className="col-9 col-sm-11">
                            <textarea type="text" className="form-control area" placeholder="Type" onChange={(e)=>{setTexto(e.target.value)}} />
                        </div>
                        <div className="col-3 col-sm-1 cajaicono ">
                        <i className="fa-solid fa-paper-plane botonenviar" onClick={()=>{EnviarMensajes()}}></i>

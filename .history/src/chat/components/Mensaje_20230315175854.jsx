        ...
        <>
            <div className="col-12 contenedorMensajeInidividual" style={
                ...
                <div id='mensaje' className="mensaje col-sm-8 col-12 " style={{
                    ...
                    borderBottomRightRadius: mensaje.email === localStorage.getItem('email') && window.innerWidth>600 ? '100px' : '10px',
                    borderTopRightRadius: mensaje.email === localStorage.getItem('email') && window.innerWidth>600 ? '0px' : '100px',
                }}>
